...
export const translations = {
  en: {
    ...
    aiSettingsMessage: "Configure your own AI provider for future assisted conversions.",
    aiEnableLabel: "Enable AI conversion when configured",
    aiProviderLabel: "Provider",
    aiProxyUrlLabel: "Proxy URL",
    aiEndpointLabel: "Endpoint",
    aiModelLabel: "Model",
    aiApiKeyLabel: "API key",
    aiRememberLabel: "Remember on this device",
    aiSettingsWarning: "API keys are not stored by default. AI conversion is not connected yet.",
  ...
  es: {
    ...
    copyButton: "Copiar",
    aiSettingsTitle: "Configuración AI",
    aiSettingsMessage: "Configura tu propio proveedor de AI para futuras conversiones asistidas.",
    aiEnableLabel: "Activar conversión AI cuando esté configurada",
    aiProviderLabel: "Proveedor",
    aiProxyUrlLabel: "Proxy URL",
    aiEndpointLabel: "Endpoint",
    aiModelLabel: "Modelo",
    aiApiKeyLabel: "API key",
    aiRememberLabel: "Recordar en este dispositivo",
    aiSettingsWarning: "Las API keys no se guardan por defecto. La conversión AI todavía no está conectada.",
    aiTestButton: "Probar conexión",
    aiClearButton: "Limpiar",
    aiSaveButton: "Guardar",
